...
//   return (
//     <div className={isDarkMode ? styles.wrapper : styles.wrapperDark}>
//       <div className={isDarkMode ? styles.formWrapperDark : styles.formWrapper}>
//         <p className={styles.loginIndicator}>
...
//               <input
//                 className={isDarkMode ? styles.input : styles.inputDark}
...
//             <button
//               className={
//                 isDarkMode ? styles.resendOtpButton : styles.resendOtpButtonDark
//               }
